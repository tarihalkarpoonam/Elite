...
class Shipment extends AbstractPdf
{
    ...
    public function getPdf($shipments = [])
    {
        ...
        foreach ($shipments as $shipment) {
            ...
            $page = $this->newPage();
            //$order = $this->Order()->getStatusHistoryCollection();
    ...
    public function newPage(array $settings = [])
    {
     ...
     protected function _drawFooter(\Zend_Pdf_Page $page,$order)
    {
        /* Add table head */
        $this->_setFontRegular($page, 10);
        $page->setFillColor(new \Zend_Pdf_Color_Rgb(0.93, 0.92, 0.92));
        ...
        //columns headers
        $lines[0][] = ['text' => __('Order Comments'), 'feed' => 35];
        ...
        foreach ($histories as $history) {
            if(!empty($history->getComment()))
            {
                $lines1[$i][] = ['text' => strip_tags($history->getComment()), 'feed' => 120];

                $lines1[$i][] = ['text' => $history->getCreatedAt(), 'feed' => 35];
                $lines1[$i][] = ['text' => '', 'feed' => 565];
                $i++;
            }
           
        }
       
        $lineBlock1 = ['lines' => $lines1, 'height' => 20];
